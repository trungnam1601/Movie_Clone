        ...
        <header className={cx('wrapper', 'container-fluid')}>
            <div className={cx('inner')}>
                ...
                {/* <div className={cx('user_SignIn')}>
                    <div className={cx('myfavourite')} onClick={() => navigate('/favorite')}>
                        <RiHomeHeartLine className={cx('myfavorite-icon')} />
                        <div className={cx('myfavourite-quantity')}>1</div>
                    </div>
                    <span className={cx('user-infor-name')}>Nam Mạc Trung</span>
                    <div className={cx('user-infor-img')}>
                        <img src={images.noImage} alt="NoImage" />
                        <Button variant="danger" className={cx('log-out')}>
                            Log Out
                        </Button>
                    </div>
                </div> */}
